...
<strong>Next step:</strong> I will pursue an M.S. at the <strong>State Key Laboratory of Precision and Intelligent Chemistry</strong> (精准智能化学全国重点实验室), <strong>University of Science and Technology of China (USTC)</strong>, from <strong>September 2026</strong> to <strong>June 2029</strong> (expected).
</div>
...
<div class="skill-pills"><span class="skill-pill">Glove box</span><span class="skill-pill">GC / LC</span><span class="skill-pill">NMR</span><span class="skill-pill">RIE / SEM / XPS</span><span class="skill-pill">FDTD</span></div>
</div>
<div class="skill-group">
<div class="skill-group-title">Other</div>
<div class="skill-pills"><span class="skill-pill">Adobe (Pr / PS / Au)</span><span class="skill-pill">Scientific visualization</span></div>
</div>
</div>

#### Research Interests

Nanomaterials, deep learning, artificial intelligence, object detection, computer vision, AI for chemistry, and intelligent methods in materials science.
